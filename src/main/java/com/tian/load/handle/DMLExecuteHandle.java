...
import com.tian.load.param.req.DMLExecReqModel;
...
public class DMLExecuteHandle extends DataBaseTradeHandle {
    protected TradeExecRespModel handle(TradeExecReqModel reqModel, Connection conn) throws SQLException {
        DMLExecReqModel ddlExecReqModel = (DMLExecReqModel)reqModel;
